...
Clone this [repository](https://github.com/brainskev/morse_code.git) to your desired folder:
...
Feel free to check the [issues page](https://github.com/brainskev/morse_code/issues).
